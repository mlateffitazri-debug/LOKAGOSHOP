  ...
  useEffect(() => {
    ...
    function render() {
      ...
      list.innerHTML = sellers.length
        ...
        : `<div style="background:#fff;border-radius:14px;padding:28px 16px;text-align:center;color:#888;border:1px solid #eee;">Belum ada kedai disimpan.</div>`
    }
