...
const scripts: string[] = ["function toggleMsg(card) {\n  var expanded = card.querySelector(\u0027.msg-expanded\u0027);\n  var isOpen = expanded.classList.contains(\u0027open\u0027);\n  // Close all\n  document.querySelectorAll(\u0027.msg-expanded.open\u0027).forEach(function(e) { e.classList.remove(\u0027open\u0027); });\n  // Open clicked if was closed\n  if (!isOpen) {\n    expanded.classList.add(\u0027open\u0027);\n    card.classList.remove(\u0027unread\u0027);\n    var dot = card.querySelector(\u0027.unread-dot\u0027);\n    if (dot) dot.style.display = \u0027none\u0027;\n  }\n}"]
