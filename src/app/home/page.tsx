...
function renderHomeMarkup(lang: Lang, sellers: Seller[], isLoading: boolean, error: string | null) {
...
export default function HomePage() {
  ...
  const markup = useMemo(
    () => renderHomeMarkup(lang, sellers, isLoading, error),
    [error, isLoading, lang, sellers],
  )
