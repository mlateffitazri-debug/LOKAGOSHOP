...
function SidebarLink({ href, icon, label }: { href: string; icon: string; label: string }) {
  return (
    <a href={href} className="flex items-center gap-3 border-b border-[#f5f5f5] bg-white px-5 py-[14px] font-['Plus_Jakarta_Sans',sans-serif] text-sm text-[#111111]">
...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed right-0 top-0 z-50 flex h-screen w-[280px] flex-col overflow-y-auto bg-white font-['Plus_Jakarta_Sans',sans-serif] shadow-[-18px_0_50px_rgba(0,0,0,0.22)] transition-transform duration-300 ease-in-out ${isSidebarOpen ? 'translate-x-0' : 'translate-x-full'}`}
        aria-hidden={!isSidebarOpen}
      >
        <header className="relative bg-[#7B1533] p-5 text-white">
          <button
            type="button"
            onClick={() => setIsSidebarOpen(false)}
            className="absolute right-4 top-4 flex h-8 w-8 items-center justify-center rounded-full bg-white/15 text-base font-bold leading-none text-white"
          ...
          <div className="flex items-center gap-3 pr-8">
            ...
            <div className="min-w-0 flex-1">
              <p className="truncate text-base font-bold text-white">{profile?.name || 'LokalGo'}</p>
              <p className="mt-0.5 truncate text-xs text-white/70">{profile?.email || 'Belum log masuk'}</p>
              <span className="mt-2 inline-flex max-w-full rounded-full bg-white/15 px-2.5 py-1 text-[11px] font-semibold text-white/85">
        ...
        <div className="flex-1 bg-white">
          ...
          <form onSubmit={handleWhatsappSubmit} className="border-b border-[#f5f5f5] bg-white px-5 py-[14px]">
            <label htmlFor="buyer-whatsapp" className="flex items-center gap-3 font-['Plus_Jakarta_Sans',sans-serif] text-sm font-semibold text-[#111111]">
              <span className="w-6 text-base">{'\u{1F4F1}'}</span>
            ...
            <input
              ...
              className="mt-3 w-full rounded-xl border border-[#E5E5EA] bg-[#FAFAFA] px-3 py-2.5 font-['Plus_Jakarta_Sans',sans-serif] text-sm text-[#111111] outline-none transition focus:border-[#7B1533] focus:bg-white"
            />
            <button
              type="submit"
              className="mt-2 w-full rounded-xl bg-[#7B1533] px-3 py-2.5 font-['Plus_Jakarta_Sans',sans-serif] text-xs font-bold text-white"
            >
              Simpan
            </button>
          ...
          <button
            type="button"
            onClick={toggle}
            className="flex w-full items-center gap-3 border-b border-[#f5f5f5] bg-white px-5 py-[14px] text-left font-['Plus_Jakarta_Sans',sans-serif] text-sm text-[#111111]"
          >
            <span className="w-6 text-base">{'\u{1F310}'}</span>
        ...
        <div className="bg-white p-4">
          <button
            ...
            className="w-full rounded-xl border-[1.5px] border-[#7B1533] px-4 py-3 font-['Plus_Jakarta_Sans',sans-serif] text-sm font-extrabold text-[#7B1533]"
          >
            Log Keluar
          </button>
        </div>
